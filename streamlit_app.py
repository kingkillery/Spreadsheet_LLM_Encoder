...
def extract_sheet_metadata(sheet):
    ...
    is_protected = sheet.protection.sheet if hasattr(
        sheet, 'protection') and hasattr(sheet.protection, 'sheet') else False
                                ...
                                if "format_regions" in sheet_data_node:
                                    ...
                                    for fmt_key_json, _ in sheet_data_node["format_regions"].items():
                                        try:
                                            ...
                                            if (
                                                number_format_str
                                                and number_format_str not in parsed_number_formats_map
                                            ):
                                                parsed_number_formats_map[
                                                    number_format_str
                                            ...
                                            if chart_anchor_col and chart_anchor_row:
                                                ...
                                                for table_dict in sheet_data_node["detected_tables"]:
                                                        if table_dict.get("full_range"):
                                                            ...
                                                            if (
                                                                r_start_col
                                                                and is_cell_within_parsed_range(
                                                                    chart_anchor_col,
                                                                    chart_anchor_row,
                                                                    r_start_col,
                                                                    r_start_row,
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            st.error(
                                "Error reading CSV file: Could not decode file "
                                "with UTF-8, latin-1, or ISO-8859-1 encoding. "
                                "Please ensure the file is saved with one of these encodings. "
                                f"Error details: {e}"
                            )
